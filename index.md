...
:::banner
This is a community project. If you are interested in contributing to the project, please consider [donating](https://square.link/u/bXGBgSf6){ target="_blank" } or becoming an [editor](https://github.com/alukosdev/saa). ❤️
:::
...
These notes were created for the sole purpose of aggregating accurate information from reliable sources to facilitate studying for the AWS Certified Cloud Practitioner Certification (CLF-C01) exam and have been shared publicly with the community.
